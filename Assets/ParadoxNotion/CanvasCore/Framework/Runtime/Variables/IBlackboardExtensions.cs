...
namespace NodeCanvas.Framework
{
    ...
    public static class IBlackboardExtensions
    {
        ...
        ///Is the blackboard part of the target blackboard upward hierarchy or the target itself
        public static bool IsPartOf(this IBlackboard blackboard, IBlackboard target) {
            if ( blackboard == null ) { return false; }
            if ( blackboard == target ) { return true; }
            return target.parent.IsPartOf(blackboard);
        }
        ...
        public static bool IsContainsVariables(this IBlackboard blackboard, string varName)
        {
            return blackboard.variables.ContainsKey(varName);
        }
